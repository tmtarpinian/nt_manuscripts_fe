<template>
    <header>
       <h1><span><router-link to='/'>NT Manuscripts</router-link></span></h1>
        <section>
...
nav ul li a:hover{background-color:#daf0ee; color:#9055a2; transition: all 0.5s ease 0s;}
nav ul li a:hover i{color:#9055a2; transition: all 0.5s ease 0s;}
nav ul li a i{padding-right:10px; color:#daf0ee; transition: all 0.5s ease 0s;}

.toggle-menu ul{display:table; width:25px;}
.toggle-menu ul li{width:100%; height:3px; background-color:#daf0ee; margin-bottom:4px;}
...
.social li a{color:#daf0ee; transition: all 0.5s ease 0s;}
.social li a:hover{color:#9055a2; transition: all 0.5s ease 0s;}
...
nav ul li a i{color:#9055a2; padding-right:13px;}
}
